...
//                 // let memberName = goWith.member.memberName;
//                 $postItem.append(`
//                     <div class="postItem-top">
//                         <a href="/goWith/goWith-detail/${goWith.id}">
...
//                                             <img src="https://static.wanted.co.kr/oneid-user/8gKFHyFwd4sSvaVWPSojfD/25182303880e93285ed1347ace3115874b9f2693e22327ccdf9c2ad17eb9be56" alt="">
//                                         </div>
//                                     </div>
...
//                         </a>
//                     </div>
//                     <a class="postItem-body postItem-image" href="/community/post/9577">
...
//                             <img class="postItemImage" src="${getFileUrl(goWith.files[0])}" alt="GoWith Image">
//                         </picture>
...
//     return `/api/files/display?fileName=${file.filePath}/${file.fileUuid}_${file.fileName}`;
// }
